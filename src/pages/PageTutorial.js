      ...
      <Container>
        <MotionContainer initial="initial" open>
          <Box sx={{ margin: 'auto' }}>
            ...
            <ul>
              <li>
                <strong>atr</strong> - ATR (dollar) Last ATR value. Usally in dollar terms. 2.14 or
                3.11
              </li>
              <li>
              ...
              <li>
                <strong>ema200</strong> - EMA 200 (boolean) Is the current stock price near the 200
                EMA? yes or no.
              </li>
              <li>
              ...
              <li>
                <strong>gap</strong> - PRICE GAPPER (boolean) Is the current price near a historical
                Gapper? yes or no.
              </li>
              <li>
                <strong>ogap</strong> - OVERNIGHT GAPPER (boolean) Is the current price near a fresh
                Overnight Gapper? yes or no.
              </li>
              <li>
              ...
              <li>
                <strong>v-pro</strong> - VOLUME PROFILE (boolean) Is the current stock price near a
                volume profile peak? yes or no.
              </li>
              <li>
                <strong>volume</strong> - VOLUME (integer) Volume of the stock. Usually in millions
                without any commas or decimal point. 1000000
              </li>
            </ul>
          </Box>
        </MotionContainer>
